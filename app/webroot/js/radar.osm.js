...
(function() {
    ...
    a = angular.module("RadarApp", [ "fechaFilters", "ui.keypress", "$strap.directives", "components", "models", "services" ]), 
    ...
    angular.module("RadarApp").controller("EventsController", [ "$http", "$location", "$scope", "$timeout", "$compile", "Compliant", "CompliantView", "Event", "EventView", "Rate", function(a, b, c, d, e, f, g, h, i, j) {
        ...
        c.event = {}, c.event.categories = [], c.locationDefault = c.cordobaSantafe, c.zoomDefault = 8, 
        c.zoomSantafe = 12, c.zoomCordoba = 11, c.zoomCity = 15, c.opciones = {
        ...
        u = $.cookie("userMapZoom"), r = $.cookie("userLastLocationString"), null != t && (c.opciones.mapTypeId = t), 
        null != u && (c.opciones.zoom = u), null != r && (c.user.location = r), d(function() {
            return c.setUserLocationByLatLng(c.opciones.center);
        }, 50)), c.map = L.mapbox.map("map", "elaleprieto.g79k5cbm").setView([ -31.64799, -60.7136 ], 15), 
        c.markers = [], c.$watch("categoriesSelected.length", function() {
            ...
            return c.deleteOverlays(), angular.forEach(c.eventos, function(a) {
                return c.createMarker(a, latlng);
            }), c.showOverlays();
            ...
            c.map.setCenter(a[0].geometry.location), c.map.setZoom(13), null != c.marker && c.marker.setMap(null), 
            ...
            c.map.setZoom(c.zoomCity), c.saveUserMapCenter(), q(a[0])), b = "<div>", b += "<p>" + p(event) + "</p>", 
            b += "<a ng-click=\"openModal('events/view/" + o(event) + "')\">", b += '<p class="text-right"><i class="icon-expand-alt"></i> info</p>', 
            b += "</a>", b += "</div>", b = e(b)(c), c.markers.push(marker);
            ...
            e = a.getSouthWest(), console.log(b), d = {
            ...
            return navigator.geolocation ? window.browserSupportFlag = !0 : void 0;
            ...
            navigator.geolocation.getCurrentPosition(function() {
                return c.map.setCenter(location), c.eventsUpdate();
            }, function() {
